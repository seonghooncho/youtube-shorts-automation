...
locals {
  ...
  runtime_config_values = {
    ...
    REDDIT_SYNTHETIC_FALLBACK_ENABLED              = "0"
    REDDIT_SYNTHETIC_FALLBACK_COUNT                = "60"
    ...
    SOURCE_LLM_EVAL_LIMIT_DEFAULT                  = "10"
    SOURCE_LLM_EVAL_LIMIT_MAX                      = "12"
    SOURCE_LOCAL_PRERANK_ENABLED                   = "1"
    SOURCE_LOCAL_HIGH_CONFIDENCE_ACCEPT_ENABLED    = "1"
    SOURCE_LOCAL_HIGH_CONFIDENCE_ACCEPT_LIMIT      = "10"
    SOURCE_LOCAL_HIGH_CONFIDENCE_MIN_PRIORITY      = "3.0"
    SOURCE_STOP_AFTER_LOCAL_HIGH_CONFIDENCE_TARGET = "0"
    SCRIPT_SOURCE_DRAFT_LIMIT                      = "10"
    SCRIPT_MAX_LLM_DRAFTS_PER_SOURCE               = "1"
    SCRIPT_NEAR_MISS_REWRITE_LIMIT                 = "0"
    ...
    SCRIPT_CRITIC_ENABLED                          = "0"
    SCRIPT_CRITIC_SAMPLE_RATE                      = "0.0"
    SCRIPT_CRITIC_ALWAYS                           = "0"
    FILTER_LOCAL_FALLBACK_ENABLED                  = "0"
    SCRIPT_LOCAL_FALLBACK_ENABLED                  = "0"
    GENERATION_PREFLIGHT_ONLY                      = "0"
    SCRIPT_CALIBRATION_MODE                        = "0"
    SCRIPT_MIN_WORDS_HARD                          = "75"
    SCRIPT_TARGET_WORDS_MIN                        = "100"
    SCRIPT_TARGET_WORDS_MAX                        = "170"
    SCRIPT_MIN_ESTIMATED_SECONDS                   = "28"
    SCRIPT_TARGET_ESTIMATED_SECONDS_MIN            = "35"
    SCRIPT_TARGET_ESTIMATED_SECONDS_MAX            = "65"
    ...
    BG_SEGMENT_CRF                                 = "18"
    BG_CONCAT_PRESET                               = "fast"
    BG_CONCAT_CRF                                  = "18"
    FINAL_RENDER_PRESET                            = "fast"
    FINAL_RENDER_CRF                               = "17"
    FINAL_RENDER_TIMEOUT_SECONDS                   = "600"
